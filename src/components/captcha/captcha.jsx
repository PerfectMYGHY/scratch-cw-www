        ...
        this.widgetId = this.grecaptcha.render(this.captchaRef,
            {
                ...
                sitekey: process.env.RECAPTCHA_SITE_KEY || "6Lf6kK4UAAAAABKTyvdSqgcSVASEnMrCquiAkjVW"
            },
            true);
    }
    setCaptchaRef (ref) {
    ...
    render () {
        return (
            <div
                ...
                data-sitekey={process.env.RECAPTCHA_SITE_KEY || "6Lf6kK4UAAAAABKTyvdSqgcSVASEnMrCquiAkjVW"}
                data-size="invisible"
...
class Captcha extends React.Component {
    ...
    executeCaptcha () {
        var base = this;
        setTimeout(function (){
            base.props.onCaptchaSolved(process.env.RECAPTCHA_SITE_KEY);
        },100);
        //this.grecaptcha.execute(this.widgetId);
    }
    render () {
