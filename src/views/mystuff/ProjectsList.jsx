...
const ProjectInfo = ({item,canRemove,canTake,text,onClick,more}) => {
...
const ProjectsList = ({items,canRemove,canTake,text,onClick,more}) => {
    return (<div class="projects-list">
        {items.map((item) => <ProjectInfo item={item} canRemove={canRemove} canTake={canTake} text={text} onClick={onClick} more={more}></ProjectInfo>)}
    </div>);
};
