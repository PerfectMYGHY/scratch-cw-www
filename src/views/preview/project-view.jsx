...
if (GUI.AddonChannels.changeChannel) {
    GUI.AddonChannels.changeChannel.addEventListener('message', e => {
        GUI.SettingsStore.setStoreWithVersionCheck(e.data);
    });
}
                    ...
                    <React.Fragment>
                        {showGUI && (
                            <IntlGUI
                                ...
                                canUseCloud={this.props.isScratcher}
                                isShared={this.props.isShared}
