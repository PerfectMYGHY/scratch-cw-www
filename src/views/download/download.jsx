            ...
            <div className="download">
                ...
                <div className="download-section faq">
                    <FlexRow className="inner column">
                        ...
                        <p>
                            <FormattedMessage
                                id="download.doIHaveToDownloadAnswer"
                                values={{
                                    baseHostName: (
                                        <a href={process.env.BASE_HOST}>{process.env.BASE_HOST}</a>
                                    )
                                }}
                            />
                        </p>
                        ...
                        {isDownloaded(this.state.OS) && (
                            <p>
                                <FormattedMessage
                                    ...
                                    values={{ operatingsystem: this.state.OS, scratchLinkLink: (<a href="/download/scratch-link">{"Scratch Link"}</a>)}}
                                />
                            </p>
                        )}
